            ...
            <div class="container">
                <div class="table" style="background-color:white;max-width:100%;">
                    <div class="row ml-20 mr-20 mt-20">
                        <div class="col-12 center-col" style="padding:20px;">
                            <div class="table" style="background-color:white;max-width:100%;"></div>
                            <div class="row mb-30">
                                <div class="col-4">
                                    <div class="row g-5">
                                        <div class="col-8">
                                            <div class="text-inputs">
                                                <div class="input-text-label">Train No and Route</div>
                                ...
                                <div class="col-4">
                                    <div class="row g-5">
                                        <div class="col-8">
                                            <div class="text-inputs">
                                                <div class="input-text-label">Class</div>
                                                <div class="width-fill">
                                                    <select class="dropdown" placeholder="Please choose">
                                                        <option value="">All</option>
                                                        <option value="" selected>1st class</option>
                                        ...
                                        <div class="col-4">
                                            <div class="text-inputs">
                                                ...
                                                <div class="input-field">
                                                    <div class="text">
                                                        <input type="text" class="type-here" placeholder="23/09/2023">
                            ...
                            <div class="row">
                                                    ...
                                                    <table class="">
                                                            ...
                                                            <tr class="row p-20">
                                                                <th class="col-2 d-flex align-items-center">
                                                                    ...
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="17"
                                                                        ...
                                                                        <path
                                                                            d="M8.49967 3.83301V13.1663M8.49967 13.1663L13.1663 8.49967M8.49967 13.1663L3.83301 8.49967"
                                                                            stroke="#667085" stroke-width="1.33333"
                                                                            stroke-linecap="round"
                                                                            stroke-linejoin="round" />
                                                                    </svg>
                                                                </th>
                                                                <th class="col-3">Train No and Route</th>
                                                        ...
                                                        <tbody>
                                                            <tr class="row p-20">
                                                                ...
                                                                <td
                                                                    class="col-3 d-flex align-items-center lightgray-font ">
                                                                    1006 Badulla &#8594 Colombo
                                                                </td>
                                                                <td class="col-2 d-flex align-items-center">Sep 23,2023
                                                                </td>
                                                                <td class="col-3 d-flex align-items-center">Moushika
                                                                    Kriyanjalee
                                                                </td>
                                                                <td class="col-2 d-flex align-items-center">
                                                                    <div class="d-flex .flex-row g-5 mr-5">
                                ...
                                <div class="activation-field">
                                    <button class="button-blue"> Proceed</button>
                                </div>
        </main>
    </div>
