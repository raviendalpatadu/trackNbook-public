        ...
        <main style="background-color:#EFF8FF; padding:20px;">
            ...
            <div class="container">
                            ...
                            <div class="row mb-30 g-20">
                                ...
                                <div class="col-3">
                                    <div class="text-inputs">
                                        ...
                                        <div class="input-field">
                                            <input type="date" name="date" class="type-here" placeholder="Type here"
                                                value="<?= get_var('from_date', 'from_date') ?>">
                                            <svg class="vector" width="20" height="20" viewBox="0 0 24 24" fill="none"
                ...
                <div class="row">
                                    ...
                                    <table class="table bg-white">
                                            ...
                                            <tbody>
                                                <tr class="row p-20">
                                                    ...
                                                    <td class="col-3 d-flex align-items-center lightgray-font ">
                    ...
                    <div class="activation-field-waiting-list">
                        <button class="button-blue-waiting-list"> Proceed</button>
                    </div>
        </main>
    </div>
