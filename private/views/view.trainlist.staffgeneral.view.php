                                ...
                                <table class="">
                                    ...
                                    <tbody>
                                        ...
                                        <?php for ($train = 0; $train < $count; $train++) : ?>
                                            <tr class="row p-20">
                                                <td class="col-3 d-flex align-items-center"><?= $data['trains'][$train]->train_name ?></td>
                                                <td class="col-1"><?= $data['trains'][$train]->train_id ?></td>
                                                <td class="col-2"><?= $data['trains'][$train]->train_type ?></td>
                                                <td class="col-3"><?= $data['trains'][$train]->start_station . " " . $data['trains'][$train]->end_station ?></td>
                                                <td class="col-2 d-flex align-items-center"><?= date("H:i", strtotime($data['trains'][$train]->train_start_time)) . " " . date("H:i", strtotime($data['trains'][$train]->train_end_time)) ?></td>

                                                <td class="col-1 d-flex align-items-center g-5">
                                                    <a class="blue" href="<?= ROOT ?>staffgeneral/updateTrain/<?=$data['trains'][$train]->train_id?>">
                                                        <div class="badge-base bg-Selected-Blue">
                                                            <div class="dot">
                                                                <div class="dot4"></div>
                                                            </div>
                                                    ...
                                                    <a class="blue" href="<?= ROOT ?>staffgeneral/deleteTrain/<?=$data['trains'][$train]->train_id?>" onclick="alert('are sure you wat to delete the train?')">
