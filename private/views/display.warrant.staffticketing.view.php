                    ...
                    <div class="row">
                        ...
                        <div class="col-5">
                            ...
                            <div class="row d-flex g-8 justify-content-center">
                                <div class="col-4">
                                    <button class="button mt-20 " id="reject"><a href="<?=ROOT?>passenger/details">
                                ...
                                <div class="col-4">
                                    <button class="button mt-20 "><a href="<?=ROOT?>staffticketing/warrants">
                                ...
                                <div class="col-4">
                                    <button class="button mt-20 "><a href="<?=ROOT?>staffticketing/warrants">
                                        <div class="button-base bg-Selected-Blue">
                                            <div class="text Blue">Verify</div>
                                        </div></a>
                                    </button> 
                                </div> 
                            </div>    
