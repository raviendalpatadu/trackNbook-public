...
$total_seats = $compartment->compartment_total_seats;
$seat_layout = $compartment->compartment_seat_layout;

$seat_layout = explode("x", $seat_layout);
$top_seats = $seat_layout[0];
$bottom_seats = $seat_layout[1];

$compartment_total_number = $compartment->compartment_total_number;
// $compartment_total_number = 2;

$total_columns = $total_seats / ($top_seats + $bottom_seats);

$total_seats = $total_seats * $compartment_total_number;
...
if (isset($data['reservation_seats']) && $data['reservation_seats'] != null) {
    foreach ($data['reservation_seats'] as $key => $value) {
            ...
            <div class="container d-flex justify-content-center">
                <div class="passenger-container">
                    ...
                    <div class="row mb-20 mobile-g-20">
                        ...
                        <div class="col-6">
                            <!-- seats selected -->
                            <div id="seatCountSelected" class="d-flex fs-30 fw align-items-end flex-column mobile-align-items-center">
                                <p class="fs-20">Seat Seleted</p>
                                <span>
                    ...
                    <div class="row">
                        <div class="col-12 d-flex align-items-center flex-column g-20">
                            <h2><?= (isset($data['compartment_type'])) ? $data['compartment_type']->compartment_class_type : "Class type not found" ?></h2>
                            <form action="" method="post" class="d-flex align-items-center flex-column g-20">
                                <?php for ($compartment = 0; $compartment < $compartment_total_number; $compartment++) : ?>
