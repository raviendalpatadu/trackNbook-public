                                        ...
                                        <div class="row d-flex align-items-center">
                                            ...
                                            <div class="col-7 d-flex center-col table profile">
                                                ...
                                                <div class="container">
                                                    ...
                                                    <<<<<<< HEAD <div
                                                        class="inquiry-container pl-30  justify-content-center">
                                                        <form action="" method="post" class="profile">
                                                                ...
                                                                <div class="col-5">
                                                                    <div class="text-inputs">
                                                                        ...
                                                                        <div class="input-field">
                                                                            <div class="text">
                                                                                <input type="text" class="type-here"
                                                                ...
                                                                <div class="col-12 d-flex justify-content-start">
                                                                    <div class="radio-buttons-container">
                                                                        <div class="radio-button">
                                                                            <input name="user_gender" value="male"
                                                                                id="radio2" class="radio-button__input"
                                                                                type="radio">
                                                                            <label for="radio2"
                                                                                class="radio-button__label <?php echo (array_key_exists('user_gender', $data['errors'])) ? 'red' : ''; ?>">
                                                                                <span
                                                                                    class="radio-button__custom"></span>
                                                                                Booking
                                                                            </label>
                                                                        </div>
                                                                        <div class="radio-button">
                                                                            <input name="user_gender" value="female"
                                                                                id="radio1" class="radio-button__input"
                                                                                type="radio">
                                                                            <label for="radio1"
                                                                                class="radio-button__label <?php echo (array_key_exists('user_gender', $data['errors'])) ? 'red' : ''; ?>">
                                                                                <span
                                                            ...
                                                            <div class="row g-30 mb-20 ">
                                                                <div class="col-10">
                                                                    <div class="text-inputs">
                                                                        <div class="input-text-label">Inquiry Details
                                                                        </div>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="text-inputs">
                                                                    ...
                                                                    <div class="input-field">
                                                                        <div class="text">
                                                                            <input type="text" class="type-here"
                                                                                placeholder="Type here" name="user_nic">
                                                                        </div>
                                                                    </div>
                                                                    <?php if (isset($data['errors'])) : ?>
                                                                    <div
