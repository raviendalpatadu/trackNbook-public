            ...
            <div class="container">
                <div class="row ml-20 mr-20 mt-20">
                    <div class="col-12 center-col">
                        <div class="row pb-20">
                            <div class="col-12">
                                <h3 class="warrant lightgray-font">Verify Warrants</h3>                          
                            </div>
                        </div>
                        <div class="row mb-30">
                                <div class="col-6">
                                    <div class="row g-5">
                                        ...
                                        <div class="text-inputs">
                                            <div class="input-text-label text lightgray-font">Train Name</div>
                                            ...
                                            <table class="">
                                                ...
                                                <tbody>
                                                    <tr class="row p-20">
                                                        ...
                                                        <td class="col-2 d-flex align-items-center">First Class</td>
                                                        ...
                                                        <td class="col-1 d-flex align-items-center"><a class="blue" href=""></a>      
                                                            <div class="badge-base bg-Selected-Blue">
                                                                ...
                                                                <div class="text blue "><a href="<?=ROOT?>staffticketing/display" >View </div> </a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr class="row p-20">
