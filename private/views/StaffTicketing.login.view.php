...
<body>
    <div class="column-left">
        ...
        <main class=" d-flex align-items-end justify-content-center">
            <img src="<?= ASSETS ?>images/home1.jpg" class="bg-home-desktop1" alt="" srcset="">
            <img src="<?= ASSETS ?>images/home-mobile.jpg" class="bg-home-mobile" alt="" srcset="">
            <div class="home-container width-fill">
                <div class="row">
                    <div class="col-12 d-flex flex-column gp-20 align-items-center">
                        <div class="home-text">
